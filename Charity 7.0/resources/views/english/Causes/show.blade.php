            ...
            <div class="event_content mb-40">
                <div class="row justify-content-center">
                    ...
                    <div class="form-group">
                      <input class="form-control" id="amount" type="text" name="amount" placeholder="Donation with Paypa">
                    </div>
                    <div class="form-group mt-2 mb-5 mb-lg-0">-->
                    <form action="https://donorbox.org/don8-dash-2"><button type= "submit" >Donation with PayPal</button>      </form>
                    <!--</div>-->
                    <!--</form> --> 
                    <!--================ Start Popular Causes Area =================-->
                    </div>
