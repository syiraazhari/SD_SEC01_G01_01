...
<div class="main-content-container container-fluid px-4" id="editor">
  ...
  <div class="page-header row no-gutters py-4">
    <div class="col-12 col-sm-4 text-center text-sm-left mb-0">
      <span class="text-uppercase page-subtitle">Event Donation</span>
      <h3 class="page-title"><i class=" icon-material-outline-assignment"></i> Add Event Donation Info</h3>
    </div>
  </div>
        ...
        <div id="form-container" class="card-body">
          ...
          <form action="{{ route('dashboardCauses.store') }}" method="POST"  role="form" enctype="multipart/form-data" class="add-new-post">
            ...
            <div class="form-control form-control-lg mb-3">
              <label for="Category">Category Event Donation</label>
              <select class="custom-select" name="category_id">
                <option value="1" selected="">Category Event Donation</option>
