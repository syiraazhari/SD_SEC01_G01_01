                ...
                @csrf
                    ...
                    <div class="wrap-input100 validate-input" data-validate="Password">
                     ...
                     <!-- Select Option Rol type -->
                        ...
                        <input class="form-check-input" type="radio" name="role_id" id="Donor" value="role_id" >
                        <label class="form-check-label" for="role_id">
                            Donor
                        </label>
                        </div>
                        <div class="form-check">
                        <input class="form-check-input" type="radio" name="role_id" id="Volunteer" value="role_id">
                        <label class="form-check-label" for="role_id">
                            Volunteer
                        </label>
                        </div>
                        <div class="form-check">
                        <input class="form-check-input" type="radio" name="role_id" id="Donee" value="role_id" >
                        <label class="form-check-label" for="role_id">
                            Donee
                        </label>
                        </div>
