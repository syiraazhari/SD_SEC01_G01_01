        ...
        <div class="container">
            ...
            <div class="event_content mb-40">
                <div class="row justify-content-center">
                    ...
                    <!--================ Start Popular Causes Area =================-->        
                    <form class="form-contact contact_form" method="POST" action="{{ route('payment') }}">
                    {{ csrf_field() }}
                     <!--id="payment-form"-->
                    <input type="hidden" name="amount" value="100">
                    <!--<div class="form-group">
                      <input class="form-control" id="amount" type="text" name="amount" value="100" placeholder="Donation with Paypal">
                    </div>-->
