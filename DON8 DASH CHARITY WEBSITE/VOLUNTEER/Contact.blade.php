  ...
  <div class="container">
    <div class="row justify-content-lg-end align-items-center banner-content">
      <div class="col-lg-5">
        ...
        <h1 class="text-white"><br>Our Organization</h1>
        <!-- ===============================  Contact  ======================================== -->
        <p><img src="http://2.bp.blogspot.com/_hQapquPXj9k/TGswMCy7GNI/AAAAAAAAAHI/duL1zIGX7DI/s1600/Logo+GPMS3.jpg" style="width:150px;height:90px;"class = "center"><br><br>{{ Setting()->about_en }}</p>
        <!-- ===============================  Contact  ======================================== -->
      </div>
    </div>
  </div>
...
<section class="section-gap">
  <div class="container">
    <div class="d-none d-sm-block mb-5 pb-4" style="overflow: hidden;">
      <!-- ===============================  Contact  ======================================== -->
      <img src="https://assets.nst.com.my/images/articles/ADFsdgsfgs_1604835510.jpg" style="width:1000px;height:500px;"class="center"/>
